...
<div class="container">
    <aside>
        ...
        <div class="sidebar">
            ...
            <a href="../PageContent/founditems/founditem.php" class="<?= $current_page === 'founditem.php' ? 'active' : '' ?>">
            ...
            <a href="../Messages/messages.php" class="<?= $current_page === 'messages.php' ? 'active' : '' ?>">
